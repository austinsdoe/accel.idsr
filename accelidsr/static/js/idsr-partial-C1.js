(function ($) {
    $(document).ready(function () {
         $("#PC1 #anonymous_patients").change(function () {
            if ($(this).is(':checked')) {
        ...
        $("#PC1 #pick_date_of_birth").hide();
        $("#PC1 .age_enter_field").hide();
        $("#PC1 #date_of_birth").click(function () {  // when the date of birth field is click
