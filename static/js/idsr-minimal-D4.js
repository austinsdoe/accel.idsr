...
(function ($) {
    $(document).ready(function () {
        ...
        $("#D4 #vaccinated_yes").click(function () {
            ...
            var vaccination_period = "-".concat($("#C1 #patient_age_years").val().
                                      concat("Y")).concat(" ").concat("-").concat($("#C1 #patient_age_month").val().
                                      concat("M")).concat(" ").concat("-").concat($("#C1 #patient_age_days").val().
                                      concat("D"));
