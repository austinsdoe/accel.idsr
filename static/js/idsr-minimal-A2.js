...
(function ($) {
    $(document).ready(function () {
        ...
        function countiesList() {
            ...
            $("#A2 #reporting_county").append(html);
        }
        ...
        function districtMap(county_select_key) {
            ...
            $("#A2 #reporting_district").empty()  //delete all options under the select with id = "district
            ...
            $("#A2 #reporting_district").append(html_district);
        }
        ...
        $("#A2").find("#reporting_county").change(function () {

            var county_key = $("#A2 #reporting_county option:selected").text();
